...
| 组件 | 状态 | 备注 |
|---|---|---|
| 拼多多引擎 | ✅ 代码完成 | Playwright 自动化，含 QR 登录 + 订单解析 |
| 京东/淘宝引擎 | ⏸️ 待开始 | PDD 稳定后再扩展 |
| 小程序前端 | ✅ 代码完成 | 5 个页面，完整功能 |
| 云函数（4个） | ✅ **已部署在线** | api-gateway, tracking-worker, engine-controller, notification-sender |
| Playwright 云托管 | ⏸️ **环境未开通** | ⚠️ CloudBase 当前为免费体验版，需升级到**个人版(¥19.9/月)**才能部署 |
| 微信订阅消息模板 | ⏸️ 待申请 | 需登录微信公众平台操作 |
